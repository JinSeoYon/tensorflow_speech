...
import input_data_trial as input_data
import models
...
def main(_):
  ...
  print(len(input_data.prepare_words_list(FLAGS.wanted_words.split(','))))
...
if __name__ == '__main__':
  ...
  #     # pylint: enable=line-too-long
  #     help='Location of speech training data on my computer')
  parser.add_argument(
      '--data_dir',
      type=str,
      default='/Users/sheoyonjin/Desktop/tensorflow-master/tensorflow/examples/speech_commands/tmp/speech_dataset/',
      help="""\
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/Users/sheoyonjin/Desktop/tensorflow-master/tensorflow/examples/speech_commands/tmp/retrain_logs',
      help='Where to save summary logs for TensorBoard.')
  parser.add_argument(
      '--wanted_words',
      type=str,
      default='bellypain,burping,hungry,discomfort,tired,bellypain2,burping2,hungry2,discomfort2,tired2',
  ...
  parser.add_argument(
      '--train_dir',
      type=str,
      default='/Users/sheoyonjin/Desktop/tensorflow-master/tensorflow/examples/speech_commands/tmp/speech_commands_train',
